...
class WeightField extends AbstractTaxonomyField implements MetaFieldInterface
{
    public function render()
    {
        ...
        $field = '<input type="hidden" name="'. esc_attr($this->getIdName()).'_type" value="'.TaxonomyMetaBoxFieldModel::WEIGHT_TYPE.'">';
    ...
    {
	    $savedValue = get_term_meta($this->termId, esc_attr($this->getIdName()).'_weight', true);
