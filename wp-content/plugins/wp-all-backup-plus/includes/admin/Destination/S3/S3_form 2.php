...
$updateMsg = '';
if (isset($_POST['wpall_amazon_s3']) && $_POST['wpall_amazon_s3'] == 'Y') {
    ...
    update_option('wpall_dest_amazon_s3_bucket', sanitize_text_field($_POST['wpall_dest_amazon_s3_bucket']));
    update_option('wpall_dest_amazon_s3_bucket_key', sanitize_text_field($_POST['wpall_dest_amazon_s3_bucket_key']));
    update_option('wpall_dest_amazon_s3_bucket_secret', sanitize_text_field($_POST['wpall_dest_amazon_s3_bucket_secret']));
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h4 class="panel-title">
            <a data-toggle="collapse" data-parent="#accordion" href="#collapses3">
                <h2>Amazon S3</h2>
            </a>
        </h4>
    </div>
    <div id="collapses3" class="panel-collapse collapse in">
        <div class="panel-body">
            <?php
            echo $updateMsg;

            if (get_option('wpall_dest_amazon_s3_bucket_key') && get_option('wpall_dest_amazon_s3_bucket_secret')) {
...
// Check for CURL
            ...
            <form  class="form-group" name="amazons3" method="post" action="">
                <input type="hidden" name="wpall_amazon_s3" value="Y">
                <input name="wpallbackup_update_setting" type="hidden" value="<?php echo wp_create_nonce('wpallbackup-update-setting'); ?>" />
                <div class="row form-group">
                    <label class="col-sm-2" for="wpall_dest_amazon_s3_bucket">Bucket Name:</label>
                    <div class="col-sm-6">

                        <input type="text" id="wpall_dest_amazon_s3_bucket" class="form-control" name="wpall_dest_amazon_s3_bucket" value="<?php echo get_option('wpall_dest_amazon_s3_bucket'); ?>" size="25" placeholder="Buket name">
                ...
                <div class="row form-group">
                    <label class="col-sm-2" for="wpall_dest_amazon_s3_bucket_key">Key:</label>
                    <div class="col-sm-6">
                        <input type="text" id="wpall_dest_amazon_s3_bucket_key" class="form-control" name="wpall_dest_amazon_s3_bucket_key" value="<?php echo get_option('wpall_dest_amazon_s3_bucket_key'); ?>" size="25" placeholder="your access key id">
                ...
                <div class="row form-group">
                    <label class="col-sm-2" for="wpall_dest_amazon_s3_bucket_secret">Secret:</label>
                    <div class="col-sm-6">
                        <input type="text" id="wpall_dest_amazon_s3_bucket_secret" class="form-control" name="wpall_dest_amazon_s3_bucket_secret" value="<?php echo get_option('wpall_dest_amazon_s3_bucket_secret'); ?>" size="25" placeholder="your secret access key">
                        <a href="http://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSGettingStartedGuide/AWSCredentials.html" target="_blank"><span class="glyphicon glyphicon-question-sign" aria-hidden="true"></span></a>
                    </div>
                </div>
