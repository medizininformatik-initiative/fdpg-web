"use strict";
(self["webpackChunkadvanced_custom_post_type"] = self["webpackChunkadvanced_custom_post_type"] || []).push([[8221],{
...
var TaxonomyMeta = function TaxonomyMeta() {
    ...
    (0, _react.useEffect)(function () {
        (0, _misc.metaTitle)("" + (0, _useTranslation2.default)("Taxonomy meta") + (isSaved ? '' : '*'));
        if (!isSaved) {
            setDirty();
        }
    }, [isSaved]);
    ...
    (0, _react.useEffect)(function () {
        if (didMountRef.current) {
            if (!saveLoading) {
                if (success) {
                    setPristine();
                    _reactToastify.toast.success((0, _useTranslation2.default)("Taxonomy meta successfully saved"));
                }
    ...
    return wp.element.createElement(
        ...
        wp.element.createElement(_ActionsBar2.default, {
            title: taxonomy + ": " + (0, _useTranslation2.default)("Manage meta fields"),
            actions: buttons
        }),
        wp.element.createElement(
            "main",
