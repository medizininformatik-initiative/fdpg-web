...
// use BitApps\AssistPro\Core\Database\Operator as DBOperator;
use BitApps\AssistPro\Core\Hooks\Hooks;
use BitApps\AssistPro\Core\Http\RequestType;
use BitApps\AssistPro\Core\Update\Updater;
use BitApps\AssistPro\Core\Utils\Capabilities;
use BitApps\AssistPro\HTTP\Middleware\IsProCheckerMiddleware;
use BitApps\AssistPro\HTTP\Middleware\NonceCheckerMiddleware;
use BitApps\AssistPro\Providers\HookProvider;
use BitApps\AssistPro\Providers\InstallerProvider;
