...
class RadioOptionPageFieldValuesTest extends AbstractTestCase
{
    /**
     * @test
     */
    public function can_add_acpt_option_page_meta_field_value()
    {
        ...
        add_acpt_option_page_meta_field(
            [
                ...
                'field_type' => OptionPageMetaBoxFieldModel::RADIO_TYPE,
                'required' => false,
                'options' => [
                        [
                                'value' => 'foo',
        ...
        $this->assertEquals('foo', $acpt_option_page_field);
    }
