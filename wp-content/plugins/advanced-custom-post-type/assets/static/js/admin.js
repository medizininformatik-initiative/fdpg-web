    ...
    $('body').on('click', '#add-grouped-element', function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                const dateRangePickerElements = document.querySelectorAll('.acpt-daterangepicker');
                ...
                // init codeMirror only on last .acpt-codemirror element
                const codeMirrorElements = document.querySelectorAll('textarea.acpt-codemirror');
                ...
                const colorPickerElements = document.querySelectorAll('.acpt-color-picker');
                ...
                const selectizeElements = document.querySelectorAll('select.acpt-select2');
