...
class TaxonomyRepository
{
    ...
    public static function get(array $meta = [], $lazy = false)
    {
        ...
        foreach ($taxonomies as $taxonomy){
	        ...
	        $taxonomyModel = self::addTemplatesToTaxonomyModel($taxonomyModel);
     ...
     * @throws \Exception
     */
    private static function addTemplatesToTaxonomyModel(TaxonomyModel $taxonomyModel)
    {
        ...
        ;", [MetaTypes::TAXONOMY ,$taxonomyModel->getSlug()]);
        ...
        foreach ($templates as $template) {
            ...
            $taxonomyModel->addTemplate($templateModel);
        }
