...
namespace BitApps\AssistPro\Core\Http\Router;
...
final class AjaxRouter
{
    ...
    public function addRoute(RouteRegistrar $route)
    {
        if (
    ...
    private function isRouteMatched(RouteRegistrar $route, $requestPath)
    {
