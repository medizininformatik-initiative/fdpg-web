...
class AddressTaxonomyFieldValuesTest extends AbstractTestCase
{
    /**
     * @test
     */
    public function can_add_acpt_tax_meta_field_value()
    {
        add_acpt_tax_meta_field(
            [
                ...
                'field_type' => TaxonomyMetaBoxFieldModel::ADDRESS_TYPE,
                'required' => false,
            ]
        );
        ...
        $this->assertEquals('Via Latina 94, 00179 Roma', $acpt_tax_field);
    }
    ...
    public function can_edit_acpt_tax_meta_field_value()
    {
        ...
        $this->assertEquals('Via Cesare Baronio 11, 00179 Roma', $acpt_tax_field);
    }
    ...
    public function can_display_acpt_tax_meta_field()
    {
        ...
        $this->assertEquals('<iframe class="maps" width="100%" height="500" src="https://maps.google.com/maps?q=Via Cesare Baronio 11, 00179 Roma&z=16&ie=UTF8&output=embed" frameborder="0" allowfullscreen></iframe>', $acpt_tax_field);
    }
