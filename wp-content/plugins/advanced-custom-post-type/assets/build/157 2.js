"use strict";
(self["webpackChunkadvanced_custom_post_type"] = self["webpackChunkadvanced_custom_post_type"] || []).push([[157],{
...
var _deleteWooCommerceProductData = __webpack_require__(44889);
...
var DeleteWooCommerceProductData = function DeleteWooCommerceProductData() {
    ...
    (0, _react.useEffect)(function () {
        (0, _misc.metaTitle)((0, _useTranslation2.default)("Delete WooCommerce product data"));
    }, []);
        ...
        if (didMountRef.current) {
            if (!loading) {
                if (success) {
                    ...
                    _reactToastify.toast.success((0, _useTranslation2.default)("WooCommerce product data successfully deleted"));
                }
    ...
    return wp.element.createElement(
        ...
        wp.element.createElement(_ActionsBar2.default, {
            title: (0, _useTranslation2.default)("Delete WooCommerce product data"),
            actions: actions
        }),
        wp.element.createElement(
            "main",
            ...
            wp.element.createElement(_Breadcrumbs2.default, { crumbs: [{
                    ...
                    label: (0, _useTranslation2.default)('Delete WooCommerce product data')
                }] }),
            wp.element.createElement(
                "p",
...
var _deleteWooCommerceProductDataActions = __webpack_require__(37461);
