...
class PhoneTaxonomyFieldValuesTest extends AbstractTestCase
{
    /**
     * @test
     */
    public function can_add_acpt_tax_meta_field_value()
    {
        add_acpt_tax_meta_field(
                [
                        ...
                        'box_name' => 'box_name',
                        'field_name' => 'Phone',
                        'field_type' => TaxonomyMetaBoxFieldModel::PHONE_TYPE,
        ...
        $this->assertEquals('+39 123456789', $acpt_tax_field);
    }
    ...
    public function can_edit_acpt_tax_meta_field_value()
    {
        ...
        $this->assertEquals('+39 987654321', $acpt_tax_field);
    }
    ...
    public function can_display_acpt_tax_meta_field()
    {
        ...
        $this->assertEquals('<a href="tel:+39 987654321" target="_blank">+39 987654321</a>', $acpt_tax_field);
    }
