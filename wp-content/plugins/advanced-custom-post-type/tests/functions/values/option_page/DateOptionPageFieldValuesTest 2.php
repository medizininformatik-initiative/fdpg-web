...
class DateOptionPageFieldValuesTest extends AbstractTestCase
{
    /**
     * @test
     */
    public function can_add_acpt_option_page_meta_field_value()
    {
        ...
        add_acpt_option_page_meta_field(
            [
                ...
                'field_type' => OptionPageMetaBoxFieldModel::DATE_TYPE,
        ...
        $this->assertEquals('2022-06-30', $acpt_option_page_field);
    }
    ...
    public function can_edit_acpt_option_page_meta_field_value()
    {
        ...
        $this->assertEquals('2020-01-31', $acpt_option_page_field);
    }
    ...
    public function can_display_acpt_option_page_meta_field()
    {
        ...
        $this->assertEquals('31/01/2020', $acpt_option_page_field);
