"use strict";
(self["webpackChunkadvanced_custom_post_type"] = self["webpackChunkadvanced_custom_post_type"] || []).push([[844],{
...
var _reactSortableHoc = __webpack_require__(28441);
...
var _fetchOptionPage = __webpack_require__(90083);
...
var OptionPageMeta = function OptionPageMeta() {

    // manage global state
    var _useParams = (0, _reactRouterDom.useParams)(),
        menuSlug = _useParams.menuSlug;
    ...
    var _useSelector2 = (0, _reactRedux.useSelector)(function (state) {
        return state.fetchOptionPageReducer;
    }),
        fetchPageLoading = _useSelector2.loading,
        fetchedPage = _useSelector2.fetched;
    ...
    (0, _react.useEffect)(function () {
        (0, _misc.metaTitle)("" + (0, _useTranslation2.default)("Option pages meta") + (isSaved ? '' : '*'));
        if (!isSaved) {
            setDirty();
        }
    }, [isSaved]);
    ...
    // populate the UI
    (0, _react.useEffect)(function () {
        dispatch((0, _fetchMeta.fetchMeta)(_metaTypes.metaTypes.OPTION_PAGE, menuSlug));
        dispatch((0, _fetchOptionPage.fetchOptionPage)(menuSlug));
    }, [saveLoading]);
    ...
    var handleDeleteAll = function handleDeleteAll() {
        dispatch((0, _deleteAllMeta.deleteAllMeta)(_metaTypes.metaTypes.OPTION_PAGE, menuSlug));
        dispatch((0, _metaStateActions.setStatusSaved)());
        setPristine();
    };
    ...
    (0, _react.useEffect)(function () {
        if (didMountRef.current) {
            if (!saveLoading) {
                if (success) {
                    setPristine();
                    _reactToastify.toast.success((0, _useTranslation2.default)("Option page meta successfully saved"));
                }
    ...
    var buttons = wp.element.createElement(
        ...
        wp.element.createElement(
            "a",
            {
                ...
                onClick: function onClick(e) {
                    e.preventDefault();
                    dispatch((0, _metaStateActions.createBox)(_metaTypes.metaTypes.OPTION_PAGE, menuSlug));
                },
                className: "acpt-btn acpt-btn-primary-o"
            },
    ...
    return wp.element.createElement(
        ...
        wp.element.createElement(_ActionsBar2.default, {
            title: fetchedPage.menuTitle + ": " + (0, _useTranslation2.default)("Manage meta fields"),
            actions: buttons
        }),
        wp.element.createElement(
            "main",
            ...
            wp.element.createElement(_Meta2.default, {
                belongsTo: _metaTypes.metaTypes.OPTION_PAGE,
                find: menuSlug,
                boxes: boxes,
                fields: fields,
                blocks: blocks,
...
exports["default"] = OptionPageMeta;
...
exports.fetchOptionPage = undefined;

var _ajax = __webpack_require__(47569);

var _fetchOptionPageActions = __webpack_require__(8447);

function _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step("next", value); }, function (err) { step("throw", err); }); } } return step("next"); }); }; }

var fetchOptionPage = exports.fetchOptionPage = function fetchOptionPage(slug) {
    return function () {
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            ...
                            dispatch((0, _fetchOptionPageActions.fetchOptionPageInProgress)(slug));
                            _context.next = 4;
                            return (0, _ajax.wpAjaxRequest)('fetchOptionPageAction', { slug: slug });

                        case 4:
                            fetched = _context.sent;

                            dispatch((0, _fetchOptionPageActions.fetchOptionPageSuccess)(fetched));
                            _context.next = 11;
                            break;
                        ...
                        case 8:
                            ...
                            dispatch((0, _fetchOptionPageActions.fetchOptionPageFailure)(_context.t0));
