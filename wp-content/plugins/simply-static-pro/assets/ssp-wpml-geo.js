...
this.getLanguagesInSwitcher=function getLanguagesInSwitcher(){let languages_links={};let languages=document.getElementsByClassName('wpml-ls-native');for(const language of languages){let language_tag=language.getAttribute('lang');let language_href=language.parentElement.getAttribute('href');if(language_tag){if(language_tag.includes("-")){let parts=language_tag.split('-');languages_links[language_tag]=parts[0];}else{languages_links[language_tag]=language_href;}}}
