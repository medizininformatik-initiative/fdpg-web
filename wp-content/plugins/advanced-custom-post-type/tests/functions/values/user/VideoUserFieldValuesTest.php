...
class VideoUserFieldValuesTest extends AbstractTestCase
{
    /**
     * @test
     */
    public function can_add_acpt_user_meta_field_value()
    {
        add_acpt_user_meta_field(
            [
                'box_name' => 'box_name',
                'field_name' => 'Video',
                'field_type' => UserMetaBoxFieldModel::VIDEO_TYPE,
	    ...
	    $this->assertNotEmpty(get_user_meta(1, 'box_name_video_id', true));
