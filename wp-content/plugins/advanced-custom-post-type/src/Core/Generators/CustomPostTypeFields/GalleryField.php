...
class GalleryField extends AbstractCustomPostTypeField implements MetaFieldInterface
{
    public function render()
    {
        ...
        $field = '<input type="hidden" name="'. esc_attr($this->getIdName()).'_type" value="'.CustomPostTypeMetaBoxFieldModel::GALLERY_TYPE.'">';
        ...
        $field .= '<input readonly '.$this->required().' id="'. esc_attr($this->getIdName()).'_copy" type="text" class="acpt-admin-meta-field-input mr-1" value="'. $defaultValue .'">';
