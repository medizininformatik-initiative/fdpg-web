Vue.component('readwise', {
    ...
    data: function () {
        ...
        fields: [
                // create customer
              {type: 'textarea', value: 'text', title: 'Text', task: ['createhighlight'], required: false},
              {type: 'textarea', value: 'title', title: 'Title', task: ['createhighlight'], required: false},
              {type: 'textarea', value: 'author', title: 'Author', task: ['createhighlight'], required: false},
...
methods: {
 ...
 template: '#readwise-action-template'
});