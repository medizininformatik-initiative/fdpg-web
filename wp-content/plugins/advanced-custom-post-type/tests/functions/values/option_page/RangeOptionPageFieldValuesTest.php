...
class RangeOptionPageFieldValuesTest extends AbstractTestCase
{
    /**
     * @test
     */
    public function can_add_acpt_option_page_meta_field_value()
    {
        ...
        add_acpt_option_page_meta_field(
            [
                ...
                'box_name' => 'box_name',
                'field_name' => 'Range',
                'field_type' => OptionPageMetaBoxFieldModel::RANGE_TYPE,
                'required' => false,
	            'advanced_options' => [
		            [
			            'key' => 'min',
    ...
    public function can_edit_acpt_option_page_meta_field_value()
    {
        ...
        $this->assertEquals(100, $acpt_option_page_field);
    }
