...
class DateRangeField extends AbstractCustomPostTypeField implements MetaFieldInterface
{
	/**
	 * @inheritDoc
	 */
	public function render()
	{
		...
		$field = '<input type="hidden" name="'. esc_attr($this->getIdName()).'_type" value="'.CustomPostTypeMetaBoxFieldModel::DATE_RANGE_TYPE.'">';
