...
class CurrencyOptionPageFieldValuesTest extends AbstractTestCase
{
    /**
     * @test
     */
    ...
    public function can_display_acpt_option_page_meta_field()
    {
        ...
        $this->assertEquals('<span class="amount">456<span class="currency">$</span></span>', $acpt_option_page_field);
    }
