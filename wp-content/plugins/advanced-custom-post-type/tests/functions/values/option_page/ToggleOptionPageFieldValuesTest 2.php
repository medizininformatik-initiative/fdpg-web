...
class ToggleOptionPageFieldValuesTest extends AbstractTestCase
{
    /**
     * @test
     */
    public function can_add_acpt_option_page_meta_field_value()
    {
        ...
        add_acpt_option_page_meta_field(
            [
                ...
                'field_type' => OptionPageMetaBoxFieldModel::TOGGLE_TYPE,
                'required' => false,
            ]
        );
        ...
        $this->assertEquals(false, $acpt_option_page_field);
    }
    ...
    public function can_edit_acpt_option_page_meta_field_value()
    {
        ...
        $this->assertEquals(true, $acpt_option_page_field);
    }
    ...
    public function can_display_acpt_option_page_meta_field()
    {
        ...
        $this->assertEquals('<span class="acpt-toggle-placeholder" style="font-size: 36px;"><span class="iconify" data-icon="bx:bx-check-circle" style="color: #02c39a;"></span></span>', $acpt_option_page_field);
    }
