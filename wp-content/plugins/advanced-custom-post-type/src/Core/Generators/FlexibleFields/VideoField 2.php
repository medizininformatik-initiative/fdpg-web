...
class VideoField extends AbstractFlexibleField implements FlexibleFieldInterface
{
    public function render()
    {
        ...
        $field = '<input type="hidden" name="'. esc_attr($this->getIdName()).'[type]" value="'.AbstractMetaBoxFieldModel::VIDEO_TYPE.'">';
        ...
        $preview = (!empty($this->getDefaultValue()) and $this->getDefaultValue() !== '') ? $this->getPreviewVideo() : '';
