...
namespace BitApps\AssistPro\Core\Http\Request;

use ArrayAccess;
use BitApps\AssistPro\Core\Helpers\Arr;
use BitApps\AssistPro\Core\Helpers\JSON;
use BitApps\AssistPro\Core\Http\IpTool;
use BitApps\AssistPro\Core\Http\Request\Validator\Validator;
use BitApps\AssistPro\Core\Http\Router\RouteRegistrar;
...
class Request implements ArrayAccess, JsonSerializable
{
     ...
     */
    public function __construct(RouteRegistrar $route = null)
    {
        $this->_route = $route;
        $this->setBody();
        $this->setQueryParams();
