...
class EmbedOptionPageFieldValuesTest extends AbstractTestCase
{
    /**
     * @test
     */
    public function can_add_acpt_option_page_meta_field_value()
    {
        ...
        add_acpt_option_page_meta_field(
            [
                ...
                'field_type' => OptionPageMetaBoxFieldModel::EMBED_TYPE,
                'required' => false,
            ]
        );
        ...
        $this->assertEquals('https://vimeo.com/747562251', $acpt_option_page_field);
    }
    ...
    public function can_edit_acpt_option_page_meta_field_value()
    {
        ...
        $this->assertEquals('https://youtu.be/araynbe6fJY', $acpt_option_page_field);
    }
