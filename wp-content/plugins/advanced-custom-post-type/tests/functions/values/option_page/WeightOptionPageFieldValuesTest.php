...
class WeightOptionPageFieldValuesTest extends AbstractTestCase
{
    /**
     * @test
     */
    ...
    public function can_display_acpt_option_page_meta_field()
    {
        ...
        $this->assertEquals('<span class="amount">1332<span class="currency">mg</span></span>', $acpt_option_page_field);
    }
