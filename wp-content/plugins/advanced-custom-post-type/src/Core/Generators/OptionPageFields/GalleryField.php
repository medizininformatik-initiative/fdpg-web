...
class GalleryField extends AbstractOptionPageField implements MetaFieldInterface
{
    public function render()
    {
        ...
        $field = '<input type="hidden" name="'. esc_attr($this->getIdName()).'_type" value="'.OptionPageMetaBoxFieldModel::GALLERY_TYPE.'">';
        ...
        $field .= '<input readonly '.$this->required().' id="'. esc_attr($this->getIdName()).'_copy" type="text" class="regular-text acpt-form-control mr-1" value="'. $defaultValue .'">';
