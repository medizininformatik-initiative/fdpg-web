"use strict";
(self["webpackChunkadvanced_custom_post_type"] = self["webpackChunkadvanced_custom_post_type"] || []).push([[1237],{
...
var _deleteTaxonomy = __webpack_require__(95613);
...
var DeleteTaxonomy = function DeleteTaxonomy() {
    ...
    (0, _react.useEffect)(function () {
        (0, _misc.metaTitle)((0, _useTranslation2.default)("Delete taxonomy"));
    }, []);
        ...
        if (didMountRef.current) {
            if (!loading) {
                if (success) {
                    ...
                    _reactToastify.toast.success((0, _useTranslation2.default)("Taxonomy successfully deleted"));
                }
    ...
    return wp.element.createElement(
        ...
        wp.element.createElement(_ActionsBar2.default, {
            title: (0, _useTranslation2.default)("Delete taxonomy"),
            actions: buttons
        }),
        wp.element.createElement(
            "main",
            ...
            wp.element.createElement(_Breadcrumbs2.default, { crumbs: [{
                    ...
                    label: (0, _useTranslation2.default)('Delete Taxonomy')
                }] }),
            wp.element.createElement(
                "h3",
...
var _deleteTaxonomyActions = __webpack_require__(34279);
