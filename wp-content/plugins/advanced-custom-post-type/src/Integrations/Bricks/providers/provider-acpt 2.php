...
class Provider_ACPT extends Base
{
    ...
    private function register_tag( $field, $parent_field = [] )
    {
	    ...
	    if ( in_array ( $type, [ CustomPostTypeMetaBoxFieldModel::REPEATER_TYPE, CustomPostTypeMetaBoxFieldModel::LIST_TYPE ] ) ) {
    ...
    private static function get_fields_by_context()
    {
        return [
            ...
            // Loop
            CustomPostTypeMetaBoxFieldModel::LIST_TYPE             => [ self::CONTEXT_LOOP ],
