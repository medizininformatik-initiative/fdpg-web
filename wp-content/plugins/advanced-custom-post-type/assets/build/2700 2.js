"use strict";
(self["webpackChunkadvanced_custom_post_type"] = self["webpackChunkadvanced_custom_post_type"] || []).push([[2700],{
...
var _assocPostTypeToTaxonomy = __webpack_require__(79635);
...
var _AssocCustomPostTypeElement = __webpack_require__(981);
...
var AssocCustomPostTypeToTaxonomy = function AssocCustomPostTypeToTaxonomy() {
        ...
        if (didMountRef.current) {
            if (!loadingAssocPostToTaxonomy) {
                ...
                if (successAssocPostToTaxonomy) {
                    _reactToastify.toast.success((0, _useTranslation2.default)("Taxonomy was associated to selected Custom post types"));
                }
    ...
    return wp.element.createElement(
        ...
        wp.element.createElement(_ActionsBar2.default, {
            title: (0, _useTranslation2.default)("Associate custom post types to") + " " + taxonomy
        }),
        wp.element.createElement(
            "main",
            null,
            ...
            fetchedPosts.length > 0 ? wp.element.createElement(
                ...
                wp.element.createElement(
                    ...
                    wp.element.createElement(
                        ...
                        fetchedPosts.length,
                        " ",
                        (0, _useTranslation2.default)("custom post types registered")
                    )
                ),
                wp.element.createElement(
                    "div",
                            ...
                            wp.element.createElement(
                                ...
                                wp.element.createElement(
                                    ...
                                    wp.element.createElement(
                                        ...
                                        (0, _useTranslation2.default)("Custom post type data")
                                    ),
                                    wp.element.createElement(
                                        "th",
...
var _assocPostToTaxonomyActions = __webpack_require__(77725);
