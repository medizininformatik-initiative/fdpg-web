...
class GalleryUserFieldValuesTest extends AbstractTestCase
{
    /**
     * @test
     */
    public function can_add_acpt_user_meta_field_value()
    {
        add_acpt_user_meta_field(
            [
                'box_name' => 'box_name',
                'field_name' => 'Gallery',
                'field_type' => UserMetaBoxFieldModel::GALLERY_TYPE,
        ...
        $add_acpt_meta_field_value = add_acpt_user_meta_field_value([
                ...
                'field_name' => 'Gallery',
                'value' => [
                    "http://xxxxxx.com/uploads/not-existing.txt"
                ],
        ]);
	    ...
	    $this->assertNotEmpty(get_user_meta(1, 'box_name_gallery_id', true));
     ...
     * @test
     */
    public function can_delete_acpt_user_meta_field_value($urls)
    {
