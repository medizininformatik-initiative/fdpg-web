...
var Settings = function Settings() {
    ...
    var languageDefaultValue = fetched.length > 0 && typeof (0, _objects.filterByLabel)(fetched, 'key', 'language').value !== 'undefined' ? (0, _objects.filterByValue)(availableLanguages, (0, _objects.filterByLabel)(fetched, 'key', 'language').value) : { value: 'en', label: "English" };
