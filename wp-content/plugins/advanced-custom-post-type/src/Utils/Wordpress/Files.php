...
class Files
{
	 ...
	 * @return array|bool
	 */
	public static function downloadFromUrl($url, $parentPostId = null)
	{
		...
		if(file_put_contents($filePath, file_get_contents($url))){
			$file = self::uploadFile($filePath, $parentPostId);
	 ...
	 * @return array|bool
	 */
	public static function uploadFile($path, $parentPostId = null)
	{
