...
class PostFieldValuesTest extends AbstractTestCase
{
    ...
    public function can_add_acpt_meta_field_value()
    {
        ...
        $this->assertEquals($this->oldest_page_id, $acpt_field['ID']);
        $this->assertEquals($this->oldest_post_id, $inversed_acpt_field['ID']);
    }
    ...
    public function can_edit_acpt_meta_field_value()
    {
        ...
        $this->assertEquals($this->second_oldest_page_id, $acpt_field['ID']);
    }
