"use strict";
(self["webpackChunkadvanced_custom_post_type"] = self["webpackChunkadvanced_custom_post_type"] || []).push([[7455],{
...
var _deletePostType = __webpack_require__(83678);
...
var DeleteCustomPostType = function DeleteCustomPostType() {
    ...
    (0, _react.useEffect)(function () {
        (0, _misc.metaTitle)((0, _useTranslation2.default)("Delete custom post type"));
    }, []);
    ...
    (0, _react.useEffect)(function () {
        if (didMountRef.current) {
            if (!loading) {
                if (success) {
                    history.push('/');
                    _reactToastify.toast.success((0, _useTranslation2.default)("Custom post type successfully deleted. The browser will refresh after 5 seconds."));
    ...
    return wp.element.createElement(
        ...
        wp.element.createElement(
            ...
            wp.element.createElement(_Breadcrumbs2.default, { crumbs: [{
                    ...
                    label: (0, _useTranslation2.default)('Delete custom post type')
                }] }),
            wp.element.createElement(
                "h3",
...
var _deleteCustomPostTypeActions = __webpack_require__(56973);
