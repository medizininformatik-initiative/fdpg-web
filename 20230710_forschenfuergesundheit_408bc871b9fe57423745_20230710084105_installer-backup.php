...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230710_forschenfuergesundheit_408bc871b9fe57423745_20230710084105_archive.zip';
        const ARCHIVE_SIZE       = '3325977406';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '408bc87-10084105';
        const SECONDARY_PACKAGE_HASH = '5a6c5e0-10084105';
        const VERSION            = '1.5.5';
