...
class HTMLOptionPageFieldValuesTest extends AbstractTestCase
{
    /**
     * @test
     */
    public function can_add_acpt_option_page_meta_field_value()
    {
        ...
        add_acpt_option_page_meta_field(
            [
                ...
                'field_type' => OptionPageMetaBoxFieldModel::HTML_TYPE,
        ...
        $this->assertEquals('<p>Standard p tag</p>', $acpt_option_page_field);
    }
    ...
    public function can_edit_acpt_option_page_meta_field_value()
    {
        ...
        $this->assertEquals('<h1>Standard h1 tag</h1>', $acpt_option_page_field);
    }
