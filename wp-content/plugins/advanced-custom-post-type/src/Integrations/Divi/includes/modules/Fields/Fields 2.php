...
class ACPT_Fields_Divi_Module extends ET_Builder_Module {
    ...
    {
        wp_register_style( 'acpt-divi-module-css', plugin_dir_url( __FILE__ ) . 'assets/css/fields.css', null, ACPT_PLUGIN_VERSION );
	...
	private static function render_the_field(array $props)
    {
        ...
        try {
            ...
            if($metaField->getType() === CustomPostTypeMetaBoxFieldModel::LIST_TYPE){
                return self::render_the_list_field($postId, $metaField, $props);
            }

            if($metaField->getType() === CustomPostTypeMetaBoxFieldModel::GALLERY_TYPE){
     ...
     * @return string
     */
    private static function default_field_render($postId, AbstractMetaBoxFieldModel $metaField, array $props)
    {
    ...
    /**
     * @TODO usare la solita visualizzazione di ACPT (enqueue scripts etc...)
     ...
     * @return string
     */
    private static function render_the_gallery_field($postId, AbstractMetaBoxFieldModel $metaField, array $props)
    {
        ...
        $values = get_acpt_field([
                'post_id' => $postId,
                'box_name' => $metaField->getMetaBox()->getName(),
     ...
     * @return string
     */
    private static function render_the_list_field($postId, AbstractMetaBoxFieldModel $metaField, array $props)
    {
        $args = [
            'post_id' => $postId,
            'box_name' => $metaField->getMetaBox()->getName(),
     ...
     */
    private static function get_acpt_field(AbstractMetaBoxFieldModel $metaField, $postId, array $props = [])
    {
        if($metaField === null){
