(self["webpackChunkadvanced_custom_post_type"] = self["webpackChunkadvanced_custom_post_type"] || []).push([[5431],{
...
function createStyleObject(classNames) {
  ...
  return classNames.reduce(function (styleObject, className) {
    return (0,objectSpread/* default */.Z)({}, styleObject, stylesheet[className]);
  }, elementStyle);
}
...
function createElement(_ref) {
  ...
  if (type === 'text') {
    ...
    var props = useInlineStyles ? (0,objectSpread/* default */.Z)({}, properties, {
      className: className && createClassNameString(className)
    }, {
      style: createStyleObject(properties.className, Object.assign({}, properties.style, style), stylesheet)
    }) : (0,objectSpread/* default */.Z)({}, properties, {
...
function LineNumbers(_ref2) {
  ...
  return react.createElement("code", (0,esm_extends/* default */.Z)({}, containerProps, {
  ...
  return function SyntaxHighlighter(_ref6) {
    var language = _ref6.language,
      ...
      style: style['code[class*="language-"]']
        ...
        rest = (0,objectWithoutProperties/* default */.Z)(_ref6, ["language", "children", "style", "customStyle", "codeTagProps", "useInlineStyles", "showLineNumbers", "startingLineNumber", "lineNumberContainerProps", "lineNumberProps", "wrapLines", "lineProps", "renderer", "PreTag", "CodeTag", "code", "astGenerator"]);
...
/* harmony default export */ const async_syntax_highlighter = (function (options) {
  ...
  function (_React$PureComponent) {
    (0,inherits/* default */.Z)(ReactAsyncHighlighter, _React$PureComponent);

    function ReactAsyncHighlighter() {
      (0,classCallCheck/* default */.Z)(this, ReactAsyncHighlighter);

      return (0,possibleConstructorReturn/* default */.Z)(this, (0,getPrototypeOf/* default */.Z)(ReactAsyncHighlighter).apply(this, arguments));
    }

    (0,createClass/* default */.Z)(ReactAsyncHighlighter, [{
      ...
      value: function render() {
        return react.createElement(ReactAsyncHighlighter.highlightInstance, (0,esm_extends/* default */.Z)({}, this.props, {
  ...
  (0,defineProperty/* default */.Z)(ReactAsyncHighlighter, "astGenerator", null);

  (0,defineProperty/* default */.Z)(ReactAsyncHighlighter, "highlightInstance", highlight(null, {}));

  (0,defineProperty/* default */.Z)(ReactAsyncHighlighter, "astGeneratorPromise", null);

  (0,defineProperty/* default */.Z)(ReactAsyncHighlighter, "languages", new Map());

  (0,defineProperty/* default */.Z)(ReactAsyncHighlighter, "supportedLanguages", options.supportedLanguages || Object.keys(languageLoaders || {}));

  (0,defineProperty/* default */.Z)(ReactAsyncHighlighter, "isRegistered", function (language) {
  ...
  (0,defineProperty/* default */.Z)(ReactAsyncHighlighter, "registerLanguage", function (name, language) {
    if (!registerLanguage) {
      throw new Error("Current syntax highlighter doesn't support registration of languages");
    }
...
var CodeWithTheme = /*#__PURE__*/Je(Code);
...
var CodeBlockWithTheme = /*#__PURE__*/Je(CodeBlock);
...
var CopyBlockWithTheme = /*#__PURE__*/Je(CopyBlock);
...
var Snippet$1 = function Snippet(_ref7) {
  ...
  var theme = (0,react.useContext)(Me);
...
var SnippetWithTheme = /*#__PURE__*/Je(Snippet$2);
