Vue.component('simvoly', {
    ...
    data: function () {
        ...
        fields: [
            ...
            {type: 'textarea', value: 'state', title: 'State', task: ['createcontact'], required: false},
            {type: 'textarea', value: 'phonenumber', title: 'Phone Number', task: ['createcontact'], required: false},
            {type: 'textarea', value: 'companyName', title: 'Company Name', task: ['createcontact'], required: false},
...
methods: {
 ...
 template: '#simvoly-action-template'
});