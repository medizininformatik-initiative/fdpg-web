...
abstract class AbstractRepeaterField
{
    /**
     * @var AbstractMetaBoxFieldModel
     */
    protected $parentFieldModel;
    ...
    public function __construct(
	    AbstractMetaBoxFieldModel $parentFieldModel,
     ...
     * @return string
     */
    protected function getPlainName()
    {
        return $this->parentFieldModel->getDbName().'_'.$this->fieldModel->getNormalizedName();
    }
    ...
    {
        return $this->parentFieldModel->getDbName().'['.$this->fieldModel->getNormalizedName().']['.$this->index.']';
    }
	...
	protected function getAttachments()
	{
		...
		$id = (isset($data[$key]) and isset($data[$key][$this->index]) and isset($data[$key][$this->index]['id']) ) ? $data[$key][$this->index]['id'] : null;
		$url = (isset($data[$key]) and isset($data[$key][$this->index]) and isset($data[$key][$this->index]['value']) ) ? $data[$key][$this->index]['value'] : null;
    ...
    protected function getParentData()
    {
		switch ($this->getMetaType()){
			case MetaTypes::OPTION_PAGE:
				return get_option($this->parentFieldModel->getDbName());

			case MetaTypes::TAXONOMY:
				return get_term_meta($this->dataId, $this->parentFieldModel->getDbName(), true);

			case MetaTypes::USER:
				return get_user_meta($this->dataId, $this->parentFieldModel->getDbName(), true);

			default:
			case MetaTypes::CUSTOM_POST_TYPE:
				return get_post_meta($this->dataId, $this->parentFieldModel->getDbName(), true);
		}
    }
}